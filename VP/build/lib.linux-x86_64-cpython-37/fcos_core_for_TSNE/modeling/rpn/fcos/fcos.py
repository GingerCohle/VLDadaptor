...
class FCOSHead(torch.nn.Module):
    ...
    def forward(self, x, act_maps=False):
        ...
        return logits, bbox_reg, centerness, cls_features
...
class FCOSModule(torch.nn.Module):
    ...
    def forward(self, images, features, targets=None, return_maps=False, act_maps= None):
        ...
        box_cls, box_regression, centerness, cls_features = self.head(features, act_maps)
        ...
        if self.training and targets:
            ...
            return self._forward_test(
                ...
                centerness, images.image_sizes, cls_features
            )
    ...
    def _forward_test(self, locations, box_cls, box_regression, centerness, image_sizes, cls_features):
        ...
        return boxes, {}, None, cls_features, scores
