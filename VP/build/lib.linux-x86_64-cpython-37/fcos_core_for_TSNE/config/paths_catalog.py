...
class DatasetCatalog(object):
    DATA_DIR ="/media/vipsl-1/Domain_adaption_repo/every_pixs_matter/EveryPixelMatters-master/dataset/"
    # dataset root
    ...
    DATASETS = {
        ...
        "cityscapes_train_cocostyle": {
            "img_dir": "FLIR/flir/day/images",
            "ann_file": "FLIR/flir/day/annotations/instances_default.json"
        },
        ...
        "cityscapes_foggy_train_cocostyle": {
            "img_dir": "FLIR/flir/1_night",
            "ann_file": "FLIR/flir/1_night/annotations/instances_default.json"
        },
        "cityscapes_val_cocostyle": {
            "img_dir": "bdd100k/dataset/bbd/bdd100k/images/100k/val",
            "ann_file": "Shift/bdd100k/val_night.json"
        },
        "cityscapes_foggy_val_cocostyle": {
            "img_dir": "FLIR/flir/7_night",
            "ann_file": "FLIR/flir/7_night/annotations/instances_default.json"
        },
