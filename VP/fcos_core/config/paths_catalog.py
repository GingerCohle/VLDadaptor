...
class DatasetCatalog(object):
    DATA_DIR = "/media/vipsl-1/Domain_adaption_repo/every_pixs_matter/EveryPixelMatters-master/dataset/" # dataset root
    ...
    DATASETS = {
        ...
        "cityscapes_train_cocostyle": {
            "img_dir": "Cityscapes/leftImg8bit/leftImg8bit/train",
        ...
        "cityscapes_val_caronly_cocostyle": {
            "img_dir": "Cityscapes/leftImg8bit/leftImg8bit/val",
            "ann_file": "Cityscapes/cocoAnnotations/cityscapes_val_caronly_cocostyle.json"
        },
        "cityscapes_foggy_train_cocostyle": {
            "img_dir": "Cityscapes/leftImg8bit_foggy/leftImg8bit_foggy/train",
        ...
        "cityscapes_foggy_val_cocostyle": {
            "img_dir": "Cityscapes/leftImg8bit_foggy/leftImg8bit_foggy/val",
        ...
        "voc_2007_cyclegan": {
            "data_dir": "style-transferred/VOC2007_to_clipart/VOC2007_to_clipart/",
            "split": "da_transferred_train"
        },
        "voc_2012_cyclegan": {
            "data_dir": "style-transferred/VOC2012_to_clipart/VOC2012_to_clipart/",
            "split": "da_transferred_train"
        },
        "voc_2007_cyclegan_water_color": {
            "data_dir": "style-transferred/VOC2007_to_watercolor/VOC2007_to_watercolor/",
            "split": "transferrd_train"
        },
        "voc_2012_cyclegan_water_color": {
            "data_dir": "style-transferred/VOC2012_to_watercolor/VOC2012_to_watercolor/",
            "split": "transferrd_train"
        },
        "voc_2007_cyclegan_comic": {
            "data_dir": "style-transferred/VOC2007_to_comic/VOC2007_to_comic/",
            "split": "transferred_train"
        },
        "voc_2012_cyclegan_comic": {
            "data_dir": "style-transferred/VOC2012_to_comic/VOC2012_to_comic/",
            "split": "transferred_train"
        },
        "kitti_train_caronly": {
            "data_dir": "KITTI",
